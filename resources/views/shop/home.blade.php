...
<div class="container">
    ...
    <div class="wrap-show-advance-info-box style-1">
        ...
        <div class="wrap-top-banner">
            <a href="#" class="link-banner banner-effect-2">
                <figure><img src="images/productcategory.jpg" width="1170" height="240" alt=""></figure>
            </a>
        </div>
        <div class="wrap-products">
            <div class="wrap-product-tab tab-style-1">
                <div class="tab-control">
                    ...
                    <a href="#lenovo" class="tab-control-item"><img src="images/brands/logo-lenovo-149x40.png" alt="LENOVO"> </a>
                    <a href="#macbook" class="tab-control-item"><img src="images/brands/logo-macbook-149x40.png" alt="MACBOOK"> </a>
                </div>
                <div class="tab-contents">
